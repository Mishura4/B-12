#ifndef SHION_VALUE_LIST_H_
#define SHION_VALUE_LIST_H_
...
namespace shion
{
  ...
  namespace _
  {
    ...
    struct value_list_helper
    {
      ...
      using type_list = shion::type_list<decltype(Args)...>;
  ...
  struct value_list
  {
    ...
    constexpr static bool has_duplicate_values = ::shion::has_duplicate_values<true, Args...>;
  ...
  struct value_list<>
  {
    ...
    using type_list = shion::type_list<>;
